...
@Component({
  selector: 'app-detail-partida-live',
  templateUrl: './detail-partida-live.component.html',
  styleUrls: ['./detail-partida-live.component.css']
})
export class DetailPartidaLiveComponent {
  ...
  playersHome: any[] =[];
  playersAway: any[] =[];
  urlBroadcast = "https://player.twitch.tv/?channel=cringestation_en&autoplay=false&parent=www.ggpedia.live" 
  listH2H: any;
  ...
  ngOnInit(): void {
    ...
    this.getDetailLiveGameForMatch();
